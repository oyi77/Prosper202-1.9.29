...
if (is_installed() == true) {
		_die("<h6>Already Installed</h6>
			  <small>You appear to have already installed Prosper202. To reinstall please clear your old database tables first. <a href='/login.php'>Login Now</a></small>");
}
...
info_top(); ?>
	...
	<?php } else { ?>
	<a href="<?php echo get_absolute_url();?>config/install.php" class="btn btn-lg btn-block btn-p202">Install Prosper202 Now <span class="glyphicon glyphicon-chevron-right"></span></a>
	<?php } ?>	
