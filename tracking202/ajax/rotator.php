		...
		<a href="#remove_rule" style="color: #34495e;"><span class="fui-cross" id="remove_rule"></span></a>
			...
			<div class="row">
				...
				<div class="col-xs-2" style="margin-left: -18px; margin-top: 10px;">
					<div class="form-group">
						<img id="addmore_criteria_loading" class="loading" src="<?php echo get_absolute_url();?>assets/img/loader-small.gif" style="display:none; position: absolute; top: 4px; left: -20px;">
					...
					<div class="row" data-redirect-id="none">
						...
						<div class="col-xs-2">
							<div class="form-group" style="  margin-left: 5px; margin-top: 8px;">
								<img id="addmore_redirects_loading" class="loading" src="<?php echo get_absolute_url();?>assets/img/loader-small.gif" style="display:none; position: absolute; top: 4px; left: -20px;">
