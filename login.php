<?php include_once(dirname( __FILE__ ) . '/config/connect.php');
   include_once(dirname( __FILE__ ) . '/config/Mobile_Detect.php');
   include_once(dirname( __FILE__ ) . '/config/vendor/autoload.php');
...
function logged_in_redirect() {
	...
	if($detect->isMobile() && !$detect->isTablet()){
		...
		header('location: '.get_absolute_url().'Mobile/mini-stats/?dni='.$dni_success);
	} else {
...
<div id='div-gpt-ad-1398648278789-0' style='width:288px; height:250px;'><center><a href="https://vpsfix.com/go/p202.php" target="_blank"><img src="https://vpsfix.com/banner/prosperlogin.gif" /></a></center></div>
</div>
    </div>
    </div>
