...
include_once(substr(dirname( __FILE__ ), 0,-12) . '/config/clickserver_api_management.php');
			...
			<div class="col-xs-12">
				<div class="panel panel-default account_left">
					<div class="panel-body">
					    If you wish to search, apply and setup offers directly from your Prosper202 dashboard, use Direct Network Integration to link Prosper202 and your network together! <a href="http://prosper.tracking202.com/blog/new-super-fast-offer-setup-with-prosperpro-dni" target="_blank">Read More...</a>
					</div>
				</div>
			</div>
		</div>
