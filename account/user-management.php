<?php include_once(substr(dirname( __FILE__ ), 0,-12) . '/config/connect.php'); 
				    	...
				    	<?php if ($editing == true) { ?>
					    	<div class="row">
					    		...
					    		<div class="col-xs-6">
									...
									<button type="submit" class="btn btn-sm btn-danger btn-block" onclick="window.location='<?php echo get_absolute_url();?>account/user-management.php'; return false;">Cancel</button>					    		</div>
					    	</div>
				    	<?php } else { ?>
