...
function get_absolute_url() {
	return substr(substr(dirname( __FILE__ ), 0,-9),strlen(realpath($_SERVER['DOCUMENT_ROOT'])));
}
?>
var config = window.config = {};
var url = '<?php echo get_absolute_url(); ?>';
	...
	*************************************************/
	...
	function setThemeState() {
		...
		if (themeSettings.themeName) {
			$styleLink.attr('href', url+'assets/css/app-' + themeSettings.themeName + '.css');
		}
		else {
			$styleLink.attr('href', url+'assets/css/app.css');
		}
